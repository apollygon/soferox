...
public:
    CMainParams() {
		...
		*/
        ...
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,63); // guarantees the first character is S
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,70); // guarantees the first character is V
